...
class JsonConvert {
  static final Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (TvItem).toString(): TvItem.fromJson,
  ...
  T? _asT<T extends Object?>(dynamic value,
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if (<Tv>[] is M) {
			return data.map<Tv>((Map<String, dynamic> e) => Tv.fromJson(e))
					.toList() as M;
		}
		if (<TvGenres>[] is M) {
			return data.map<TvGenres>((Map<String, dynamic> e) =>
					TvGenres.fromJson(e)).toList() as M;
		}
		if (<TvItem>[] is M) {
			return data.map<TvItem>((Map<String, dynamic> e) => TvItem.fromJson(e))
					.toList() as M;
		}
		if (<TvLastEpisodeToAir>[] is M) {
			return data.map<TvLastEpisodeToAir>((Map<String, dynamic> e) =>
					TvLastEpisodeToAir.fromJson(e)).toList() as M;
		}
		if (<TvNetworks>[] is M) {
			return data.map<TvNetworks>((Map<String, dynamic> e) =>
					TvNetworks.fromJson(e)).toList() as M;
		}
		if (<TvNextEpisodeToAir>[] is M) {
			return data.map<TvNextEpisodeToAir>((Map<String, dynamic> e) =>
					TvNextEpisodeToAir.fromJson(e)).toList() as M;
		}
		if (<TvProductionCountries>[] is M) {
			return data.map<TvProductionCountries>((Map<String, dynamic> e) =>
					TvProductionCountries.fromJson(e)).toList() as M;
		}
		if (<TvSeasons>[] is M) {
			return data.map<TvSeasons>((Map<String, dynamic> e) =>
					TvSeasons.fromJson(e)).toList() as M;
		}
		if (<TvSpokenLanguages>[] is M) {
			return data.map<TvSpokenLanguages>((Map<String, dynamic> e) =>
					TvSpokenLanguages.fromJson(e)).toList() as M;
		}
		...
		if (<MovieSearchResponse>[] is M) {
			return data.map<MovieSearchResponse>((Map<String, dynamic> e) =>
					MovieSearchResponse.fromJson(e)).toList() as M;
		}
		...
		if (<TvOnTheAirResponse>[] is M) {
			return data.map<TvOnTheAirResponse>((Map<String, dynamic> e) =>
					TvOnTheAirResponse.fromJson(e)).toList() as M;
		}
		if (<TvPopularResponse>[] is M) {
			return data.map<TvPopularResponse>((Map<String, dynamic> e) =>
					TvPopularResponse.fromJson(e)).toList() as M;
		}
		if (<TvRecommendationResponse>[] is M) {
			return data.map<TvRecommendationResponse>((Map<String, dynamic> e) =>
					TvRecommendationResponse.fromJson(e)).toList() as M;
		}
		if (<TvSearchResponse>[] is M) {
			return data.map<TvSearchResponse>((Map<String, dynamic> e) =>
					TvSearchResponse.fromJson(e)).toList() as M;
		}
